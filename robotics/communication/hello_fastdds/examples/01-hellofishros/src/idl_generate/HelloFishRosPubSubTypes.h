...
/*!
 * @file HelloFishRosPubSubTypes.h
...
#ifndef _HELLOFISHROS_PUBSUBTYPES_H_
#define _HELLOFISHROS_PUBSUBTYPES_H_

#include <fastdds/dds/topic/TopicDataType.hpp>
#include <fastrtps/utils/md5.h>

#include "HelloFishRos.h"

#if !defined(GEN_API_VER) || (GEN_API_VER != 1)
#error Generated HelloFishRos is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif  // GEN_API_VER

/*!
 * @brief This class represents the TopicDataType of the type HelloWorld defined by the user in the IDL file.
 * @ingroup HELLOFISHROS
 */
...
#endif // _HELLOFISHROS_PUBSUBTYPES_H_